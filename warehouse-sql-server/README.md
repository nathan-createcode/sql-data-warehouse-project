> **Note:** This is the original (legacy) implementation of this project, built with SQL Server / T-SQL. It has since been re-implemented using a modern Python + dbt + PostgreSQL stack — see [`../warehouse-dbt-postgres`](../warehouse-dbt-postgres). Both versions are kept here to show the project's evolution. For the overall repository overview, see the [root README](../README.md).
...
| **Gold** | Views | No Load | Data Integrations, Aggregations, Business Logic | Star Schema, Flat Table, Aggregated Table |
...
|
├── datasets/                    # Raw datasets used for the project (ERP and CRM data) - not committed, see root .gitignore
|
